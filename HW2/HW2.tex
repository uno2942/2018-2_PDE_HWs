...
u(x,t)=\frac{1}{2}[g(x+t)+g(x-t)]+\frac{1}{2}\int_{x-t}^{x+t} h(y)dy + \frac{1}{2}\int_0^t\int_{x+t-s}^{x-t+s}f(y, s)dyds.
\end{equation}
...
Also,
\begin{equation*}
\lim_{\mathclap{\substack{(x,t)\rightarrow (x_0, 0)\\ t>0}}} u(x,t)=g(x_0, 0),~~\lim_{\mathclap{\substack{(x,t)\rightarrow (x_0, 0)\\ t>0}}} u_t(x,t)=h(x_0, 0)
\end{equation*}
